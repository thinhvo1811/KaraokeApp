 ...
 * @author dell
 */
public class JPanel_TKDTTheoThangNV extends javax.swing.JPanel {

    /**
     * Creates new form JPanelTKDTTheoNgay
     */
    public JPanel_TKDTTheoThangNV() {
	...
	private CategoryDataset createDataset() {
		...
		double tongDT=0;
		for(int j=1;j<=31;j++) {
			ArrayList<HoaDon> dsHD = hoaDon_DAO.getHDTheoThangvaNV(thang, nam, j, maNV);
			int i = 0;
			double tongDTN=0;
			for(HoaDon hd : dsHD) {
